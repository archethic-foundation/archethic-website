...
export enum InternalLinks {
  ...
  WhitePaper = 'https://www.archethic.net/ARCHEthic_WhitePaper.pdf',
  TechnicalPaper = 'https://www.archethic.net/ARCHEthic_YellowPaper.pdf',
...
export enum ExternalLinks {
  ...
  Tokenomics = 'https://www.archethic.net/ARCHEthic_UCOnomics.pdf',
