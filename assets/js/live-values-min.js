...
async function displaystats() {
    await getstats(), document.querySelector("#live-feed-price").innerText = current_price, document.querySelector("#current-circulating-supply").innerText = calc_M_or_B(current_circulating_supply);
    let e = current_circulating_supply * current_price;
    document.querySelector("#current-market-cap").innerText = calc_M_or_B(e)
}
