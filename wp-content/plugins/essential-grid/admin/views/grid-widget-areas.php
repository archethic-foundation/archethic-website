...
?>
		...
		if(is_array($sidebars) && !empty($sidebars)){
			foreach($sidebars as $handle => $name){
				...
				<div class="eg-pbox esg-box" style="width:100%;min-width:500px">
					<h3 class="box-closed"><span style="font-weight:400"><?php _e('Handle:', EG_TEXTDOMAIN); ?></span><span>eg-<?php echo $handle; ?> </span><div class="eg-pbox-arrow"></div></h3>
					<div class="esg-box-inside" style="display:none;padding:0px !important;margin:0px !important;height:100%;position:relative;background:#ebebeb">
						...
						<div class="eg-widget-area-save-wrap-settings">
							<a class="esg-btn esg-blue eg-widget-area-edit" href="javascript:void(0);"><?php _e('Edit', EG_TEXTDOMAIN); ?></a>
							<a class="esg-btn  eg-widget-area-delete" href="javascript:void(0);"><?php _e('Remove', EG_TEXTDOMAIN); ?></a>
						</div>
					</div>
				</div>
				<?php
	...
	<a class="esg-btn esg-blue" id="eg-widget-area-add" href="javascript:void(0);"><?php _e('Add New Widget Area', EG_TEXTDOMAIN); ?></a>
