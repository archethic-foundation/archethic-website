...
jQuery(document).ready(function($) {
	...
	$('.cq-draggable-container').each(function(index) {
	    ...
	    $('.cq-draggable-slider', _this).on('click', function(event) {
	    	...
	    	var _currentnum = Math.floor((100*relX/$(this).parent().width()+2)*_avatarnum/100);
	    	_drag.setValue(relX/$(this).parent().width(), true);
	    });
