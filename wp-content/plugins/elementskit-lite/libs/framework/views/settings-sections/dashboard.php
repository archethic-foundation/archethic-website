...
<div class="ekit-admin-section ekit-admin-dual-layout ekit-admin-documentation-section">
    ...
    <div class="ekit-admin-right-content">
        ...
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="https://wpmet.com/elementskit-docs" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-newspaper-o"></i><?php esc_html_e('Get started', 'elementskit-lite'); ?></a>
        </div>
    </div>
</div>
